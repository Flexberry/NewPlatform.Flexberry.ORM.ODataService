...
CREATE TABLE LegoPatent (
 ...
 /BaseLegoBlock_m0 UUID NULL,

 /BaseLegoBlock_m1 UUID NULL,
...
CREATE INDEX Indexb43131b348ee335105dd990a690720791b5dcba6 on Блоха (МедведьОбитания); 
 ...
 ALTER TABLE LegoPatent ADD CONSTRAINT FKe371de37f3b3ea04227552de1ee882c38df3f428 FOREIGN KEY (/BaseLegoBlock_m0) REFERENCES LegoBlock; 
CREATE INDEX Indexe371de37f3b3ea04227552de1ee882c38df3f428 on LegoPatent (/BaseLegoBlock_m0); 

 ALTER TABLE LegoPatent ADD CONSTRAINT FK2094cdf96c723881d619e851a1ab2d56ade718af FOREIGN KEY (/BaseLegoBlock_m1) REFERENCES LegoDevice; 
CREATE INDEX Index2094cdf96c723881d619e851a1ab2d56ade718af on LegoPatent (/BaseLegoBlock_m1); 
...
CREATE INDEX Indexaa1a3fec50499d204c389473163d0d8f55d4aed9 on STORMAuEntity (upper(ObjectPrimaryKey)); 
