...
ALTER TABLE "AgregatorWithSameMAndD"
	ADD CONSTRAINT "AgregatorWithSameMAndD_FDe_217" FOREIGN KEY ("Master") REFERENCES "DetailAndMaster" ("primaryKey");

CREATE INDEX "AgregatorWithSameMAndD_IMaster" on "AgregatorWithSameMAndD" ("Master");

ALTER TABLE "DetailAndMaster"
	ADD CONSTRAINT "DetailAndMaster_FAgregator_188" FOREIGN KEY ("Agregator") REFERENCES "AgregatorWithSameMAndD" ("primaryKey");
