namespace NewPlatform.Flexberry.ORM.ODataService.Tests
{
    ...
    public class MultiThreadingTestTool
    {
        ...
        /// <summary>
        /// Имя параметра в коллекции значений, переданных в тестовый метод, указывающее на имя потока.
        /// </summary>
        public const string ParamNameThreadName = "threadName";
        ...
        public void StartThreads(int count, object sender = null)
        {
            ...
            {
                var threadDict = new Dictionary<string, object>(dictionary);
                threadDict[ParamNameThreadName] = thread.Name;
                thread.Start(threadDict);
            }
