...
#endif
#if NETCOREAPP
        public CreateWithPseudoDetailDefinedTest(CustomWebApplicationFactory<ODataServiceSample.AspNetCore.Startup> factory, Xunit.Abstractions.ITestOutputHelper output) : base(factory, pseudoDetailDefinitions: GetPseudoDetailDefinitions())
        {
        }
#endif
